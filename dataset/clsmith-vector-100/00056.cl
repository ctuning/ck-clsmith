// ---fake_divergence -g 2,13,71 -l 1,1,1
#define int64_t long
...
__kernel void entry(__global ulong *result, __global int *sequence_input) {
    ...
    struct S0* p_3 = &c_4;
    struct S0 c_5 = {
        (VECTOR(int32_t, 2))(0x7C203980L, 0L), // p_3->g_2
    ...
    transparent_crc(p_3->g_2.x, "p_3->g_2.x", print_hash_value);
    transparent_crc(p_3->g_2.y, "p_3->g_2.y", print_hash_value);
