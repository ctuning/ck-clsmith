...
__kernel void entry(__global ulong *result, __global int *sequence_input) {
    ...
    struct S1* p_3 = &c_4;
    struct S1 c_5 = {
        {{254UL,1UL,0xDDL,0x22L,1UL,0x22L},{254UL,1UL,0xDDL,0x22L,1UL,0x22L},{254UL,1UL,0xDDL,0x22L,1UL,0x22L}}, // p_3->g_2
    ...
    for (i = 0; i < 3; i++)
    {
        for (j = 0; j < 6; j++)
        {
            transparent_crc(p_3->g_2[i][j], "p_3->g_2[i][j]", print_hash_value);
