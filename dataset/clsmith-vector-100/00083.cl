// ---fake_divergence -g 11,1,1 -l 1,1,1
#define int64_t long
...
int32_t  func_1(struct S7 * p_3)
{ /* block id: 4 */
    VECTOR(uint64_t, 8) l_2 = (VECTOR(uint64_t, 8))(0xA21E1D82C32B96CEL, (VECTOR(uint64_t, 4))(0xA21E1D82C32B96CEL, (VECTOR(uint64_t, 2))(0xA21E1D82C32B96CEL, 2UL), 2UL), 2UL, 0xA21E1D82C32B96CEL, 2UL);
    int i;
    return l_2.s6;
}
