// --atomics 80 ---atomic_reductions ---fake_divergence ---inter_thread_comm -g 35,4,9 -l 7,1,1
#define int64_t long
...
{4,6,0,5,3,1,2}, // permutation 0
{2,5,1,3,6,0,4}, // permutation 1
{6,5,4,2,0,3,1}, // permutation 2
{6,4,2,1,5,0,3}, // permutation 3
{1,3,0,6,5,4,2}, // permutation 4
{1,4,0,5,6,2,3}, // permutation 5
{1,0,2,4,5,6,3}, // permutation 6
{3,5,6,1,0,2,4}, // permutation 7
{4,0,5,3,6,1,2}, // permutation 8
{6,5,4,3,1,0,2} // permutation 9
};
...
__kernel void entry(__global ulong *result, __global volatile uint *g_atomic_input, __global volatile uint *g_special_values, __global volatile int *g_atomic_reduction, __global int *sequence_input, __global long *g_comm_values) {
    ...
    struct S4 c_8 = {
        ...
        (safe_add_func_uint32_t_u_u((safe_mul_func_uint32_t_u_u(get_linear_group_id(), 7)), permutations[0][get_linear_local_id()])), // p_6->tid
    ...
    transparent_crc(p_6->g_comm_values[get_linear_group_id() * 7 + get_linear_local_id()], "p_6->g_comm_values[get_linear_group_id() * 7 + get_linear_local_id()]", print_hash_value);
