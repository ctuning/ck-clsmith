// --atomics 91 ---atomic_reductions ---fake_divergence ---inter_thread_comm -g 40,13,8 -l 1,1,2
#define int64_t long
...
/* ------------------------------------------ */
/* 
 * reads : p_6->g_4 p_6->l_comm_values
 * writes: p_6->g_5
 */
uint32_t  func_1(struct S3 * p_6)
{ /* block id: 4 */
    ...
    int32_t **l_3 = (void*)0;
    (*p_6->g_4) = l_2;
    return p_6->l_comm_values[(safe_mod_func_uint32_t_u_u(p_6->tid, 2))];
}
...
__kernel void entry(__global ulong *result, __global volatile uint *g_atomic_input, __global volatile uint *g_special_values, __global volatile int *g_atomic_reduction, __global int *sequence_input, __global long *g_comm_values) {
    ...
    struct S3 c_8 = {
        ...
        (safe_add_func_uint32_t_u_u((safe_mul_func_uint32_t_u_u(get_linear_group_id(), 2)), permutations[0][get_linear_local_id()])), // p_6->tid
    ...
    transparent_crc(p_6->g_comm_values[get_linear_group_id() * 2 + get_linear_local_id()], "p_6->g_comm_values[get_linear_group_id() * 2 + get_linear_local_id()]", print_hash_value);
