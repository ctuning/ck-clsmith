// --atomics 64 ---atomic_reductions ---fake_divergence ---inter_thread_comm -g 99,8,12 -l 1,1,3
#define int64_t long
...
__kernel void entry(__global ulong *result, __global volatile uint *g_atomic_input, __global volatile uint *g_special_values, __global volatile int *g_atomic_reduction, __global int *sequence_input, __global long *g_comm_values) {
    ...
    struct S3 c_4 = {
        ...
        (safe_add_func_uint32_t_u_u((safe_mul_func_uint32_t_u_u(get_linear_group_id(), 3)), permutations[0][get_linear_local_id()])), // p_2->tid
    ...
    transparent_crc(p_2->g_comm_values[get_linear_group_id() * 3 + get_linear_local_id()], "p_2->g_comm_values[get_linear_group_id() * 3 + get_linear_local_id()]", print_hash_value);
