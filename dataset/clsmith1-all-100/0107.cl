// --atomics 69 ---atomic_reductions ---fake_divergence ---inter_thread_comm -g 30,47,6 -l 5,1,1
#define int64_t long
...
{1,0,4,2,3}, // permutation 1
{1,2,4,0,3}, // permutation 2
{4,3,2,0,1}, // permutation 3
{3,4,2,1,0}, // permutation 4
{1,3,4,2,0}, // permutation 5
{1,3,4,2,0}, // permutation 6
{2,0,1,4,3}, // permutation 7
{3,0,4,2,1}, // permutation 8
{2,4,3,1,0} // permutation 9
};
...
/* 
 * reads : p_9->g_3
 * writes: p_9->g_3 p_9->g_7
 */
uint32_t  func_1(struct S2 * p_9)
{ /* block id: 4 */
    int32_t *l_6 = &p_9->g_3;
    for (p_9->g_3 = 0; (p_9->g_3 == 19); p_9->g_3++)
    { /* block id: 7 */
        p_9->g_7 = l_6;
    }
    return (*l_6);
...
__kernel void entry(__global ulong *result, __global volatile uint *g_atomic_input, __global volatile uint *g_special_values, __global volatile int *g_atomic_reduction, __global int *sequence_input, __global long *g_comm_values) {
    ...
    struct S2 c_11 = {
        ...
        (safe_add_func_uint32_t_u_u((safe_mul_func_uint32_t_u_u(get_linear_group_id(), 5)), permutations[0][get_linear_local_id()])), // p_9->tid
    ...
    transparent_crc(p_9->g_8, "p_9->g_8", print_hash_value);
    ...
    transparent_crc(p_9->g_comm_values[get_linear_group_id() * 5 + get_linear_local_id()], "p_9->g_comm_values[get_linear_group_id() * 5 + get_linear_local_id()]", print_hash_value);
