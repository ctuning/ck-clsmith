// --atomics 76 ---fake_divergence -g 17,50,2 -l 1,50,2
#define int64_t long
...
__kernel void entry(__global ulong *result, __global volatile uint *g_atomic_input, __global volatile uint *g_special_values, __global int *sequence_input) {
    ...
    struct S5* p_4 = &c_5;
    struct S5 c_6 = {
        {0x59CDC345L,0x59CDC345L,0x59CDC345L}, // p_4->g_2
    ...
    for (i = 0; i < 3; i++)
    {
        transparent_crc(p_4->g_2[i], "p_4->g_2[i]", print_hash_value);
