// ---fake_divergence ---inter_thread_comm -g 22,59,4 -l 2,1,1
#define int64_t long
...
int32_t  func_1(struct S3 * p_5);


/* --- FUNCTIONS --- */
/* ------------------------------------------ */
/* 
 * reads : p_5->g_comm_values p_5->g_3 p_5->g_4 p_5->l_comm_values
 * writes: p_5->g_4
 */
int32_t  func_1(struct S3 * p_5)
{ /* block id: 4 */
    int32_t *l_2 = (void*)0;
    (*p_5->g_3) ^= p_5->g_comm_values[p_5->tid];
    l_2 = &p_5->g_4;
    return p_5->l_comm_values[(safe_mod_func_uint32_t_u_u(p_5->tid, 2))];
}
...
__kernel void entry(__global ulong *result, __global int *sequence_input, __global long *g_comm_values) {
    ...
    struct S3 c_7 = {
        ...
        (safe_add_func_uint32_t_u_u((safe_mul_func_uint32_t_u_u(get_linear_group_id(), 2)), permutations[0][get_linear_local_id()])), // p_5->tid
    ...
    transparent_crc(p_5->g_comm_values[get_linear_group_id() * 2 + get_linear_local_id()], "p_5->g_comm_values[get_linear_group_id() * 2 + get_linear_local_id()]", print_hash_value);
