// ---atomic_reductions ---fake_divergence -g 68,21,3 -l 1,3,1
#define int64_t long
...
uint32_t  func_1(struct S4 * p_8);


/* --- FUNCTIONS --- */
/* ------------------------------------------ */
/* 
 * reads : p_8->g_2 p_8->g_5
 * writes: p_8->g_5 p_8->g_7
 */
uint32_t  func_1(struct S4 * p_8)
{ /* block id: 4 */
    int32_t *l_3 = (void*)0;
    int32_t *l_4 = &p_8->g_5[0];
    int32_t *l_6 = &p_8->g_7;
    (*l_6) = ((*l_4) = p_8->g_2);
    (*l_6) = p_8->g_2;
    return p_8->g_5[0];
