// ---fake_divergence -g 94,40,2 -l 1,20,2
#define int64_t long
...
int64_t  func_1(struct S1 * p_11);


/* --- FUNCTIONS --- */
/* ------------------------------------------ */
/* 
 * reads : p_11->g_5 p_11->g_8
 * writes: p_11->g_5 p_11->g_8
 */
int64_t  func_1(struct S1 * p_11)
{ /* block id: 4 */
    int64_t l_3 = 0x04CCB63E8E1B8814L;
    uint32_t *l_4 = &p_11->g_5;
    int32_t *l_6 = (void*)0;
    int32_t *l_7 = &p_11->g_8;
    struct S0 *l_10 = (void*)0;
    struct S0 **l_9 = &l_10;
    (*l_7) = ((safe_unary_minus_func_uint32_t_u(((*l_4) = l_3))) && p_11->g_5);
    (*l_9) = (void*)0;
    return (*l_7);
}
